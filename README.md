...
# Usage
`from beiwedata import *` is the standard way to import and this document will assume `beiwe-desktop` has been imported to the top level. If you `import as`, please adjust the usage examples accordingly.
